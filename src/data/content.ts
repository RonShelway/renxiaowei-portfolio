    ...
    items: [
      {
        ...
        bullets: {
          zh: [
            '参与MA营销增长平台的产品规划与功能迭代，围绕业务增长场景进行需求分析、竞品调研与产品方案设计。',
            '输出PRD文档与高保真原型，使用Figma/墨刀完成交互方案设计，协同算法与业务团队推动功能落地与迭代优化。',
            '参与智能保顾AI产品的用户调研与体验优化，通过客服访谈、用户反馈与行为数据分析识别核心使用痛点。',
            '基于用户需求与业务场景，制定产品优化方案，持续优化AI产品交互体验与用户使用效率。',
          ],
          en: [
